...
# Step 16: Indicate success
echo "All files processed successfully!"
touch "${input_file}_processed.success"

# Step 17: Delete all .fasta files in the current directory
...
# Step 18: Move all folders (excluding the current directory) to modeller_output
echo "Moving all directories to ../modeller_output..."
mkdir -p ../modeller_output  # Ensure the target directory exists
find . -maxdepth 1 -type d -not -path "." -not -name "scwrl4" -exec mv {} ../modeller_output/ \;
